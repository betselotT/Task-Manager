      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-blue-900/20 backdrop-blur-sm">
        ...
        >
          <div className="flex justify-between items-center p-4 border-b border-blue-100">
            <h2 className="text-xl font-semibold text-blue-900">Edit Task</h2>
          ...
          <form onSubmit={handleSubmit} className="p-4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="dueDate" className="block text-sm font-medium text-blue-700 mb-1">
                  Due Date
                </label>
              ...
              <div>
                <label htmlFor="priority" className="block text-sm font-medium text-blue-700 mb-1">
                  Priority
                </label>
                <select
                  id="priority"
